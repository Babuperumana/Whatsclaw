...
module.exports = {
    ...
    vazhipadu: {
        ...
        dakshina_ask_text: 'Would you like to offer *Dakshina* to the temple priest for performing the vazhipadus?',
        dakshina_yes: '🙏 Yes',
        dakshina_no: '❌ No',
        dakshina_invalid: "Please tap 'Yes' or 'No'.",
        dakshina_amount_prompt: 'Please enter the Dakshina amount you wish to offer (in ₹):',
        dakshina_invalid_amount: 'Please enter a valid amount (a positive number).',
        summary_title: '📝 *Booking Summary*',
        summary_item: '{n}. *{name}*\n   Devotee: {devotee}\n   Nakshathram: {nak}\n   Date: {date}\n   Amount: ₹{price}',
        summary_dakshina: '*Dakshina: ₹{dakshina}*',
    ...
    admin_panchangam: {
        ...
        nakshathram_section: '⭐ 24-hour Nakshatram Details:',
        nakshathram_segment: '   {name} ({start} to {end})',
        nakshathram_today_label: '📌 Primary Nakshatram (Today/Tomorrow):',
